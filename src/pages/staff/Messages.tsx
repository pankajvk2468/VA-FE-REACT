...
const StaffMessages: React.FC = () => {
  ...
  const messages = [
    { id: '1', from: 'John Doe', subject: 'Question about application', date: '2024-01-15', preview: 'I need help with...', isRead: false },
    { id: '2', from: 'Jane Smith', subject: 'Form submission issue', date: '2024-01-14', preview: 'There was an error...', isRead: true },
  ];

  return (
    <div className="fade-in">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Staff Messages</h1>
